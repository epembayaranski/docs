...
<Steps>
  ...
  <Step title="Setelah menekan tombol Cari pada bagian Pencarian, akan muncul tabel daftar mahasiswa. Selanjutnya tekan tombol simpan tagihan untuk melakukan proses simpan tagihan.">
    - Setelah dilakukan proses menyimpan tagihan, status pembayaran Calon Mahasiswa tersebut di aplikasi eRegistrasi akan menjadi Belum Lunas. Apabila belum melakukan setting tagihan dan belum menyimpan tagihan tersebut, status pembayaran di eRegistrasi adalah Belum Bayar. Hal ini juga berlaku untuk jenis pembayaran lainnya.
