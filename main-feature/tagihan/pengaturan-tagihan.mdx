...
<Steps>
  ...
  <Step title="Pada halaman Pengaturan Tagihan, sesuaikan filter pencarian untuk menampilkan data Tagihan mahasiswa yang ingin anda atur, kemudian klik tombol Tampilkan.">
  ...
  <Step title="Tombol Filter Detail merupakan tombol tambahan untuk pencarian data lebih akurat, terlebih dalam keadaan khusus.">
    ...
    ![Filterpengaturantagihan](/images/Filterpengaturantagihan.png)

    Gambar. Filter pengaturan tagihan
  </Step>
